...
async def solve_captcha(shadow: str = Form(...), back: str = Form(...)):
    """
    Solve the captcha by processing the shadow and background image URLs.

    :param shadow: URL of the shadow (gap) image.
    :param back: URL of the background image.
